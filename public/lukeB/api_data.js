define({ "api": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "lat",
            "description": "<p>Latitude of users current position</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "long",
            "description": "<p>Longitude of users current position</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "report",
            "description": "<p>True if user made the report at the position.</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "visited",
            "description": "<p>If true, user has visited the place</p>"
          },
          {
            "group": "Success 200",
            "type": "Boolean",
            "optional": true,
            "field": "place",
            "description": "<p>returns place that was visited. Only appears if place was visited.</p>"
          }
        ]
      }
    },
    "description": "<p>Checks if user coordinates are in range of place and records the visit in the user profile and place. If user has visited the place &amp; made a report there, the report value won't be overwritten for user later on to a false if he visits the place again and doesn't make a report. User data has record of a single visit to a place. Place model contains records of each visit from a user to a place, if the user has made a report on that visit and date when visit was made.</p>",
    "error": {
      "examples": [
        {
          "title": "No places:",
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "image",
            "description": "<p>Base64 string representing jpeg image</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "description": "<p>Create report using provided parameters. Date is currently created on the server side. Maybe make it client side? Returns created report.</p>",
    "version": "0.0.0",
    "filename": "routes/lukeB/routes/report.js",
    "groupTitle": "Report",
    "error": {
  ...
  },
  {
    ...
    "description": "<p>Updates the report by id. Location of report cannot be updated. Returns updated report.</p>",
    "error": {
      "examples": [
        {
          "title": "Access restriction:",
  ...
  },
  {
    ...
    "description": "<p>Returns single json object containing user information if the id was provided. Returns every user if no id is provided.</p>",
    "version": "0.0.0",
    "filename": "routes/lukeB/routes/user.js",
    "groupTitle": "User",
    "error": {
